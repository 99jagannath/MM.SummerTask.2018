 ...
 <div class="mainbody">
 	<div class="row upperpart">
 		<div class="posts col-md-9 col-sm-12">
 			...
 			<h1 style="text-align: center;">Ask Your Question Here!!</h1><hr>
 			<?php 
    if($feedback=$this->session->flashdata('question')) :
  ...
  <?php endif;?>
 			<br>
 			<?php echo form_open('login/question_added') ?>
 		...
 		<?php  $option=array(
                   ...
                   'other'=>'other'
 	           	 ...
 	           	 echo form_dropdown('type',$option) ?><br>
 	           	 <br>
 	           	 <?php echo form_input(['name'=>'name','placeholder'=>'Enter Your Name','type'=>'text','value'=>set_value('name')]) ?><br>
 	           	 <?php echo form_error('name');?>
 	           	 <br>
 	           	 <?php echo form_input(['name'=>'email','placeholder'=>'Enter Your Email','type'=>'varchar','value'=>set_value('email')]) ?><br>
 	           	 <?php echo form_error('email');?>
 	           	 <br>
 	           	 <?php echo form_input(['name'=>'mobileno','placeholder'=>'Enter Your Mobile no','type'=>'bigint','value'=>set_value('mobileno')]) ?><br>
 	           	 <?php echo form_error('mobileno');?>
 	           	  <br>
 	           <?php echo form_textarea(['name'=>'question','placeholder'=>'ASk Your Question Here','type'=>'text','value'=>set_value('question')]) ?><br>
 	           <?php echo form_error('question');?>
 	           	 <br>
              <?php echo form_reset(['name'=>'submit','value'=>'reset','class'=>'btn btn-default'])  ?>

              <?php echo form_submit(['name'=>'submit','value'=>'question','class'=>'btn btn-primary'])  ?>
 	...
 	<?php if(count($question)):
 		...
 		<div class="row">
 			...
 			<h2 style="color: blue"><?php echo $j." - ".$item->question."<br>"; ?><h2>
 				<br>
