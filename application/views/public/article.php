 ...
 <div class="mainbody">
 	<div class="row upperpart">
 		<div class="posts col-md-9 col-sm-12">
 			...
 			<h1 style=" margin-left:15%; "><strong><?php echo $article->title; ?></strong></h1><hr>
 			<h3 style="margin-left: 10%;"><?php echo $article->date?> | <?php echo $article->author ?></h3><br>
 			<h2 style="margin-left: 10%;"><?php echo $article->tag;?></h2><br>
 			<h3 style="margin-left: 10%;"><?php echo $article->body;?></h3>
 			<hr>
 			<div class="comment" style="margin-right:14%; margin-left: 14%;">
 				<h2>Comments</h2>
 			<?php
 			$j=1; 
 			...
 			<div style="background-color: #EBF4FA; border-radius: 50px; height: 100px; margin-left:15%;margin-right: 20%; ">
            ...
            ?><h3 style=" margin-left:20%;margin-right: 20%;">replies</h3>
 			<div style="background-color: #7FFFD4; border-radius: 50px; height: 100px; margin-left:25%;margin-right: 20%; ">
 			...
 			<p style="color: red;margin-left: 5%;">for giving comments you have to login.</p>
    ...
    <button name='submit', value='comment', id='articleslogin', class ='btn btn-primary'>comment</button>
 			</div>	
