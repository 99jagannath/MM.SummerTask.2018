...
<div class="row secondheader">
 ...
 <div class="row answer" style="margin-left: 20%;margin-right: 20%;">
 	<div><?= anchor("admin/see_answer/{$ip}","view answers",['class'=>'btn btn-success']); ?> <br></div>
 	<hr>
 	<?php
 	if($answers):
 		$j=1;
 		foreach ($answers as $answer):
 			?>
 		<div><span>Question - <?=$j?> : </span>
 		<?php echo $answer->question;?><br></div>
 		 <div><span>answer : </span>
 		 <?php echo $answer->answer;?><br></div>
 		 <br>
 	<?php	
     ++$j;
 endforeach;
