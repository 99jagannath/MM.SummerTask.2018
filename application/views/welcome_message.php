    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html" style="text-align: center;">Admin Pannel</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="#">New Posts</a><!-- flot.html  -->
                                </li>
                                <li>
                                    <a href="#">Delete Post</a><!-- morris.html  -->
                                </li>
                                <li>
                                    <a href="#">Update Post</a><!-- morris.html  -->
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-edit fa-fw"></i> carosel</a><!-- forms.html  -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-table fa-fw"></i> department</a><!-- tables.html  -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-table fa-fw"></i> Editor Pic</a><!-- tables.html  -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-table fa-fw"></i> issues</a><!-- tables.html  -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i> Right Part<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="#">squiggles</a><!-- panels-wells.html  -->
                                </li>
                                <li>
                                    <a href="#">Pic of the week</a><!-- buttons.html  -->
                                </li>
                                <li>
                                    <a href="#">student Paules</a><!-- notifications.html  -->
                                </li>
                                <li>
                                    <a href="#">vedio</a><!-- typography.html  -->
                                </li>
                                <li>
                                    <a href="#"> link</a><!-- icons.html  -->
                                </li>
                                <li>
                                    <a href="#">Citizen Jounalism</a><!-- grid.html  -->
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="#">User Profile</a><!-- blank.html  -->
                                </li>
                                <li>
                                    <a href="#">Logout Page</a><!-- login.html  -->
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
